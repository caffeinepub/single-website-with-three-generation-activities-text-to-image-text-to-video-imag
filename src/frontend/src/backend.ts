...
import type { BuildActivity as _BuildActivity, Time as _Time, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getBuildHistory(arg0: Principal): Promise<Array<BuildActivity>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBuildHistory(arg0);
    ...
    async recordBuild(arg0: string, arg1: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordBuild(arg0, to_candid_opt_n9(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_BuildActivity_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BuildActivity): BuildActivity {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        artifactUri: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.artifactUri)),
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_BuildActivity>): Array<BuildActivity> {
    return value.map((x)=>from_candid_BuildActivity_n4(_uploadFile, _downloadFile, x));
}
